      ...
      <ul class="nav">
        ...
        <div class="sub">
          <ul>
            ...
            <li class='current'><a href='/idea' title='品牌理念'>品牌理念</a></li>
...
<div class="top_bg1">
  <div class="container">
    <div class="location">
      <span><a href='/' title='首页'>首页</a>&nbsp;&gt;&nbsp;品牌介绍&nbsp;&gt;&nbsp;品牌理念</span>
    </div>
    <div class="p_l">
      <ul>
        <li><a href='/brand' title='关于品牌'>关于品牌</a></li>
...
<div class="container pt">
  ...
  <style>
.con{font-size:14px;}
  .con strong{color:#0e468d;}
  .con h2{font-size:20px;color:#0e468d;}
