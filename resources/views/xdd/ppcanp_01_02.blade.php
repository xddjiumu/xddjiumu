...
<div class="top_bg2">
  ...
  <div class="container">
    <div class="location">
      <span><a href='index.asp' title='首页'>首页</a>&nbsp;&gt;&nbsp;关于我们</span>
    </div>
    <div class="p_l">
      <ul>
        <li class='current'><a href='/product'>精品宝白系列管材 </a></li>
        <li><a href='/productt'>精品宝绿系列管材</a></li>
        <li><a href='/producs'>PE-RT采暖管</a></li>
...
<div class="container pt prolist pp">
  <div class='viewpro'>
    <a href="/product">返回</a>
  </div>
  ...
  <ul>
    <li><img src='/xdd/images/1.jpg' alt='PP-R热水管'>
    <h3>PP-R热水管</h3>
    </li>
    <li><img src='/xdd/images/2.jpg' alt='PP-R冷水管'>
    <h3>PP-R冷水管</h3>
    </li>
    <li><img src='/xdd/images/3.jpg' alt='等径直接'>
    <h3>等径直接</h3>
    </li>
    <li><img src='/xdd/images/4.jpg' alt='45度弯头'>
    <h3>45度弯头</h3>
    </li>
    <li><img src='/xdd/images/5.jpg' alt='90度弯头'>
    <h3>90度弯头</h3>
    </li>
    <li><img src='/xdd/images/6.jpg' alt='异径直接'>
    <h3>异径直接</h3>
    </li>
    <li><img src='/xdd/images/7.jpg' alt='异径三通'>
    <h3>异径三通</h3>
    </li>
    <li><img src='/xdd/images/8.jpg' alt='异径弯头'>
    <h3>异径弯头</h3>
    </li>
    <li><img src='/xdd/images/9.jpg' alt='正三通'>
    <h3>正三通</h3>
    </li>
    <li><img src='/xdd/images/10.jpg' alt='全塑活接'>
    <h3>全塑活接</h3>
    </li>
    <li><img src='/xdd/images/11.jpg' alt='内丝直接'>
    <h3>内丝直接</h3>
    </li>
    <li><img src='/xdd/images/12.jpg' alt='外丝直接'>
    <h3>外丝直接</h3>
    </li>
    <li><img src='/xdd/images/13.jpg' alt='内丝弯头'>
    <h3>内丝弯头</h3>
    </li>
    <li><img src='/xdd/images/14.jpg' alt='外丝弯头'>
    <h3>外丝弯头</h3>
    </li>
    <li><img src='/xdd/images/15.jpg' alt='内丝三通'>
    <h3>内丝三通</h3>
    </li>
    <li><img src='/xdd/images/16.jpg' alt='外丝三通'>
    <h3>外丝三通</h3>
    </li>
    <li><img src='/xdd/images/17.jpg' alt='精品截止阀'>
    <h3>精品截止阀</h3>
    </li>
    <li><img src='/xdd/images/18.jpg' alt='内丝活接'>
    <h3>内丝活接</h3>
    </li>
    <li><img src='/xdd/images/19.jpg' alt='外丝活接'>
    <h3>外丝活接</h3>
    </li>
    <li><img src='/xdd/images/20.jpg' alt='暗阀'>
    <h3>暗阀</h3>
    </li>
    <li><img src='/xdd/images/21.jpg' alt='双活接铜球阀'>
    <h3>双活接铜球阀</h3>
    </li>
    <li><img src='/xdd/images/22.jpg' alt='双活接铜球阀'>
    <h3>双活接铜球阀</h3>
    </li>
    <li><img src='/xdd/images/23.jpg' alt='直接活接'>
    <h3>直接活接</h3>
    </li>
    <li><img src='/xdd/images/24.jpg' alt='正弯活接'>
    <h3>正弯活接</h3>
    </li>
    <li><img src='/xdd/images/25.jpg' alt='铜芯全塑阀'>
    <h3>铜芯全塑阀</h3>
    </li>
    <li><img src='/xdd/images/26.jpg' alt='连体三通'>
    <h3>连体三通</h3>
    </li>
    <li><img src='/xdd/images/27.jpg' alt='连体弯头'>
    <h3>连体弯头</h3>
    </li>
    <li><img src='/xdd/images/28.jpg' alt='短过桥'>
    <h3>短过桥</h3>
    </li>
    <li><img src='/xdd/images/29.jpg' alt='U型管卡'>
    <h3>U型管卡</h3>
    </li>
    <li><img src='/xdd/images/30.jpg' alt='管帽'>
    <h3>管帽</h3>
    </li>
    <li><img src='/xdd/images/31.jpg' alt='管堵'>
    <h3>管堵</h3>
    </li>
    <li><img src='/xdd/images/32.jpg' alt='单截止阀'>
    <h3>单截止阀</h3>
    </li>
    <li><img src='/xdd/images/33.jpg' alt='双截止阀'>
    <h3>双截止阀</h3>
    </li>
  </ul>
