      ...
      <ul class="nav">
        ...
        <div class="sub">
          <ul>
            ...
            <li class='/marketing'><a href='/marketingone' title='在线加盟'>在线加盟</a></li>
          </ul>
        </div>
        </li>
        <li id="m7" class="m">
...
<div class="top_bg5">
  <div class="container">
    <div class="location">
      <span><a href='index.asp' title='首页'>首页</a>&nbsp;&gt;&nbsp;营销网络&nbsp;&gt;&nbsp;在线加盟</span>
    </div>
    <div class="p_l">
      <ul>
        <li><a href='/marketing' title='网络分布'>网络分布</a></li>
        <li class='current'><a href='/marketingone' title='在线加盟'>在线加盟</a></li>
      </ul>
    </div>
  </div>
</div>
  ...
  <form method="post" action="marsave.asp">
    ...
    function UpVerifyCode(){
      document.getElementById("PhotoSN").src = "Vieinc/VerifyCode.asp?t="+Math.random();
        ...
        <li class="w100 job_btn"><input type="submit" name="send" value="提交"/></li>
      </ul>
    </div>
  </form>
  <div class="clear">
