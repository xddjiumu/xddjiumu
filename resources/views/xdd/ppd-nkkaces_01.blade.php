  ...
  <div class="header">
    ...
    <div id="menu">
      <ul class="nav">
        ...
        <div class="sub">
          <ul>
            <li class='/marketing'><a href='/case' title='合作伙伴'>合作伙伴</a></li>
...
<div class="top_bg7">
  <div class="container">
    <div class="location">
      <span><a href='index.asp' title='首页'>首页</a>&nbsp;&gt;&nbsp;项目案例&nbsp;&gt;&nbsp;合作伙伴</span>
    </div>
    <div class="p_l">
      <ul>
        <li class='current'><a href='/case' title='合作伙伴'>合作伙伴</a></li>
        <li><a href='/caseone' title='经典案例'>经典案例</a></li>
      </ul>
    </div>
  </div>
...
<div class="container pt">
  ...
  <div style="text-align: center;">
    <h2><br/></h2>
    <img src="/xdd/images/partner.png" alt=""/>
  </div>
  <div class="clear">
  </div>
</div>
