          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>Title</th> <th>Body</th> <th>Category_id</th> <th>View_count</th> <th>Order</th> <th>Excerpt</th> <th>Slug</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$topic->title}}</td> <td>{{$topic->body}}</td> <td>{{$topic->category_id}}</td> <td>{{$topic->view_count}}</td> <td>{{$topic->order}}</td> <td>{{$topic->excerpt}}</td> <td>{{$topic->slug}}</td>
