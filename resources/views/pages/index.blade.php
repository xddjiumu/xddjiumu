  ...
  <div class="container pt-5">
    <div class="row">
      <div class="col-md-6">
        ...
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/about_pic.jpg" class="img-fluid mb-3 w-100" alt="Responsive image">
      ...
      <div class="col-md-6">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/about_pic1.jpg" class="img-fluid mb-3 w-100" alt="Responsive image">
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/1.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/2.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/3.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/4.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/5.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/6.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/7.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/8.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/9.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container pt-5">
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/about_pic2.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
    </div>
  </div>
</section>
...
<section>
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/21.gif" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/22.gif" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/23.gif" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6 text-center">
        <img src="https://thitxdd.oss-cn-hangzhou.aliyuncs.com/jomuxdd/24.gif" class="img-fluid mb-3" alt="Responsive image">
      </div>
    </div>
  </div>
</section>
