  ...
  <div class="container pt-5">
    <div class="row">
      <div class="col-md-6">
        ...
        <img src="/images/about_pic.jpg" class="img-fluid mb-3" alt="Responsive image">
      ...
      <div class="col-md-6">
        <img src="/images/about_pic1.jpg" class="img-fluid mb-3" alt="Responsive image">
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-3 col-sm-6">
        <img src="/images/1.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6">
        <img src="/images/2.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6">
        <img src="/images/3.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6">
        <img src="/images/4.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6">
        <img src="/images/5.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6">
        <img src="/images/6.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6">
        <img src="/images/7.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6">
        <img src="/images/8.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
      <div class="col-md-3 col-sm-6">
        <img src="/images/9.jpg" class="img-fluid mb-3" alt="Responsive image">
      </div>
    </div>
  </div>
</section>
